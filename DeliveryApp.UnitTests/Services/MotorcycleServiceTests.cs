...
namespace DeliveryApp.UnitTests.Services
{
    public class MotorcycleServiceTests
    {
        ...
        private readonly Mock<IMessageBusService> _messageBusService;
        ...
        public MotorcycleServiceTests()
        {
            ...
            _messageBusService = new Mock<IMessageBusService>();
            _service = new MotorcycleService(_repositoryMock.Object, 
                _createValidatorMock.Object, 
                _updateValidatorMock.Object, 
                _messageBusService.Object);
        }
